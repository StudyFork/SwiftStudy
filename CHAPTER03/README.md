...
### 다양한 크기의 Int와 UInt 타입

|타입명|크기|
|-|-|
|Int8, UInt8|1byte (8bit)|
|Int16, UInt16|2byte (16bit)|
|Int32, UInt32|4byte (32bit)|
|Int64, UInt64|8byte (64bit)|
...
|진수|방법|예시|
|-|-|-|
|10진수|평소에 표현 하던 숫자와 동일하게 작성하면 된다.|171|
|2진수|**접두어(prefix)** 에 **`0b`** 를 사용하여 표현한다.|171 -> 0b10101011|
|8진수|**접두어(prefix)** 에 **`0o`** 를 사용하여 표현한다.|171 -> 0o253|
|16진수|**접두어(prefix)** 에 **`0x`** 를 사용하여 표현한다.|171 -> 0xAB|
